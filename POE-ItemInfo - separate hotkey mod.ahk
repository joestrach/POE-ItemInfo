...
/*
; ### This is the usual method to trigger the parse function, commented out so it will no longer automatically activate on clipboard change ###
; ### At the very end of the script, a key got assigned to start parsing instead ###
OnClipBoardChange:
    Global Opts
